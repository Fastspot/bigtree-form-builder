...
<fieldset id="<?=$field_name?>">
	...
	<div class="form_builder_wrap">
		...
		<div class="form_builder_phone_country">
			<input type="text" maxlength="3" name="<?=$field_name?>[first]" id="form_builder_field_<?=$count?>" class="form_builder_text<?php if ($field_data["required"]) { ?> form_builder_required<?php if ($error && (strlen($default["first"]) != 3 || !is_numeric($default["first"]))) { ?> form_builder_error<?php } ?><?php } ?>" value="<?=htmlspecialchars($default["first"])?>" autocomplete="<?=$section_token?> tel-country-code"<?php if (!empty($field_data["required"])) { ?> required<?php } ?>>
		...
		<div class="form_builder_phone_area">
			<input type="text" maxlength="3" name="<?=$field_name?>[second]" id="form_builder_field_<?=$count?>" class="form_builder_text<?php if ($field_data["required"]) { ?> form_builder_required<?php if ($error && (strlen($default["second"]) != 3 || !is_numeric($default["second"]))) { ?> form_builder_error<?php } ?><?php } ?>" value="<?=htmlspecialchars($default["second"])?>" autocomplete="<?=$section_token?> tel-area-code"<?php if (!empty($field_data["required"])) { ?> required<?php } ?>>
