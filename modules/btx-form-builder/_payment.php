...
<fieldset>
	...
	<input id="form_builder_base_price" type="text" name="base_price" value="$<?=number_format($form["base_price"] ?? 0, 2)?>" placeholder="Enter a numeric value." />
</fieldset>

<fieldset>
	<input id="form_builder_early_bird" type="checkbox" name="early_bird" <?php if (!empty($form["early_bird_date"])) { ?> checked="checked"<?php } ?> />
	<label for="form_builder_early_bird" class="for_checkbox">Early Bird Pricing</label>
</fieldset>

<div class="contain" id="form_builder_early_bird_container"<?php if (empty($form["early_bird_date"])) { ?> style="display: none;"<?php } ?>>
	<hr>
	...
	<fieldset class="left">
		...
		<input id="form_builder_early_bird_base_price" type="text" name="early_bird_base_price" value="$<?=number_format($form["early_bird_base_price"] ?? 0, 2)?>" placeholder="Enter a numeric value." />
	</fieldset>
